const addVariablesForColors = require("./tailwind-plugins/addVariablesForColors");
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        background: "#faf7f7", // Example color for background

        border: "#cccccc", // Example color for border
      ...
      boxShadow: {
        ...
        glow: "0 0 20px 10px rgba(255, 0, 0, 1)",
      },
      keyframes: {
        scroll: {
          to: {
